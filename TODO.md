...
**State 2026-09-17 (`main` @ `de60bac`): build complete and review-hardened.** Stages 1–3 are built
(DEC-023). The review-panel dossier is adjudicated and its accepted fixes are merged (T-051 → T-052 →
...
**After submission:** plan §5 P1 items T-054, T-055, T-057 (T-056/T-058 wording done 2026-09-17).
T-059 (`tunnelscope serve`, local upload dashboard) built and verified 2026-09-17 — a genuinely new
capability, not on the pre-review roadmap; consider it for the demo alongside `DEMO-SCRIPT.md`.
...
| T-057 | P2 | TODO (post-submission) | ESP length offsets for UDP-encapsulated ESP and IPv6 — plan §5 P1-4 | Crafted captures: `esp_content` and cipher sieve correct, or UNKNOWN | — |
