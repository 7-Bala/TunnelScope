...
// Uploaded captures are labelled by filename, which can be long: shorten for the axis,
// and leave room on the left for the first label, which is rotated back over the margin.
