...
# Source build installs to /usr/libexec/ipsec/charon (not /usr/lib/ipsec/charon
# as the Debian apt package does) — autoconf's libexecdir default.
CHARON=/usr/libexec/ipsec/charon
[ -x "$CHARON" ] || CHARON=/usr/lib/ipsec/charon
exec "$CHARON" 2>&1
