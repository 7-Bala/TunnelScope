...
| OQ-30 | Does Palo Alto's Quantum Readiness view assess THIRD-PARTY IPsec passing through the firewall? | Decides whether a commercial product already covers this | Palo Alto docs (T-025) | — | **CLOSED — NO. Its inventory relies on decryption logs + session metadata for TLS/SSH and covers its OWN VPN tunnels; third-party IPsec merely transiting is not inventoried. The doc-11 gap stands.** |
